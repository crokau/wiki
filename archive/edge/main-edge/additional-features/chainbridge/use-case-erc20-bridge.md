...
Before starting this step, please make sure that you've started a relayer. Please check [Setup](/docs/edge/additional-features/chainbridge/setup) for more details.
